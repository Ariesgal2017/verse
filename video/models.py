...
from versevsverse.helpers import user_vid_path, gen_uuid, user_sound_path
...
class Video(models.Model):
    creator = models.ForeignKey('verser.CustomUser', null=True, blank=True, on_delete=models.CASCADE, related_name="video_creator")
...
class Comment(models.Model):
    user = models.ForeignKey('verser.CustomUser', null=True, blank=True, on_delete=models.CASCADE, related_name="commenter")
    comment = models.CharField(max_length=60, null=True, blank=True)
    likes = models.IntegerField(default=0)
    liked_by = models.ManyToManyField('verser.CustomUser', blank=True, related_name="like_list")
