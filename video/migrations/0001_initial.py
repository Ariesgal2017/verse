    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_by', models.ManyToManyField(blank=True, related_name='like_list', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('audio_file', models.FileField(upload_to=versevsverse.helpers.user_sound_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.IntegerField(default=versevsverse.helpers.gen_uuid, unique=True)),
                ('video', models.FileField(upload_to=versevsverse.helpers.user_vid_path)),
                ('privacy', models.CharField(choices=[('PRV', 'Private'), ('PUB', 'Public')], max_length=3)),
                ('likes', models.IntegerField(default=0)),
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now)),
