...
from versevsverse.helpers import auth_user, check_for_name, check_for_username
...
class MainView(View):
    ...
    def get(self, request):
        ...
        suggested_creators = CustomUser.objects.all().filter(verified=True).order_by('followers')[:10]
